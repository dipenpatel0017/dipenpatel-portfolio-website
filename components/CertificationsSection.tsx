...
export function CertificationsSection() {
  ...
  const certifications = [
    ...
    },
    {
      ...
      issuer: 'Coursera',
      date: '2025',
      description: 'Comprehensive course on data mining techniques, algorithms, and practical applications for extracting insights from large datasets.',
      icon: '📊',
      image: 'from-teal-500/20 via-cyan-500/20 to-blue-500/20',
      skills: ['Data Mining', 'Machine Learning', 'Statistical Analysis', 'Data Visualization'],
      download: false,
    },
    {
      ...
      issuer: 'Coursera',
      date: '2025',
      description: 'Learn to build production-ready generative AI applications using modern LLMs, prompt engineering, and advanced AI techniques.',
      icon: '🤖',
      image: 'from-violet-500/20 via-purple-500/20 to-pink-500/20',
    ...
    },
    {
      ...
      issuer: 'Coursera',
      date: '2025',
      description: 'Master Power BI for financial analysis, creating dashboards, and data-driven decision making in finance sector.',
      icon: '💹',
      image: 'from-yellow-500/20 via-orange-500/20 to-red-500/20',
      skills: ['Power BI', 'Business Intelligence', 'Financial Analysis', 'Data Visualization'],
      download: false,
    },
    {
      title: 'Core Java',
      issuer: 'Coursera',
      date: '2025',
      description: 'Fundamental Java programming concepts, object-oriented design, and building robust applications with Java ecosystem.',
      icon: '☕',
      image: 'from-amber-500/20 via-orange-500/20 to-yellow-500/20',
